"""Tests for the Arris TG2492LG device tracker."""
...
from homeassistant.components.arris_tg2492lg.device_tracker import async_setup_scanner
...
async def test_legacy_platform_creates_issue_on_cannot_connect(
    ...
    mock_connect_box.return_value.async_login.side_effect = ClientResponseError(
...
async def test_legacy_import_clears_stale_cannot_connect_issue(
    ...
    mock_connect_box.return_value.async_get_connected_devices.return_value = (
        MOCK_DEVICES
    )
