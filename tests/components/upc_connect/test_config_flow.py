"""Tests for the UPC Connect Box config flow."""

from unittest.mock import AsyncMock, MagicMock

from connect_box.exceptions import ConnectBoxLoginError
...
async def test_user_flow_success(
    hass: HomeAssistant, mock_setup_entry: AsyncMock, mock_connect_box: MagicMock
) -> None:
