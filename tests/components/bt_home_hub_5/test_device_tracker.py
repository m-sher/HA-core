"""Tests for the BT Home Hub 5 device tracker."""

from unittest.mock import AsyncMock, MagicMock

from homeassistant.components.bt_home_hub_5.const import DOMAIN
from homeassistant.components.bt_home_hub_5.device_tracker import async_setup_scanner
...
async def test_entities_created(
    ...
    mock_get_bt_home_hub_5_data: MagicMock,
...
async def test_legacy_platform_imports_config_entry(
    hass: HomeAssistant, mock_get_bt_home_hub_5_data: MagicMock
) -> None:
...
async def test_legacy_platform_creates_issue_on_cannot_connect(
    ...
    mock_get_bt_home_hub_5_data.return_value = None
...
async def test_legacy_import_clears_stale_cannot_connect_issue(
    ...
    mock_get_bt_home_hub_5_data.return_value = MOCK_DEVICES
