"""Tests for the Aruba device tracker."""

from unittest.mock import AsyncMock, MagicMock

from homeassistant.components.aruba.const import DOMAIN
from homeassistant.components.aruba.device_tracker import async_setup_scanner
...
async def test_legacy_platform_imports_config_entry(
    hass: HomeAssistant, mock_get_aruba_data: MagicMock
) -> None:
...
async def test_legacy_platform_creates_issue_on_cannot_connect(
    ...
    mock_get_aruba_data.return_value = None
...
async def test_legacy_import_clears_stale_cannot_connect_issue(
    ...
    mock_get_aruba_data.return_value = MOCK_DEVICES
