...
async def async_setup_entry(
    ...
    """Set up the Cisco IOS device tracker from a config entry."""
...
class CiscoIOSScannerEntity(
    ...
    """Representation of a device connected to a Cisco IOS router."""
    ...
    def is_connected(self) -> bool:
        """Return true if the device is in the ARP table."""
