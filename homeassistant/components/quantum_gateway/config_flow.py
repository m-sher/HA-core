"""Config flow for the Quantum Gateway integration."""
...
def _can_connect(host: str, password: str, use_https: bool) -> bool:
    """Return True if the gateway accepts credentials."""
    try:
        scanner = QuantumGatewayScanner(host, password, use_https)
