"""Config flow for the Aruba integration."""
...
from .coordinator import get_aruba_data
...
class ArubaConfigFlow(ConfigFlow, domain=DOMAIN):
    """Handle a config flow for Aruba."""

    VERSION = 1

    async def _async_can_connect(self, user_input: dict[str, Any]) -> bool:
        """Return true if the Aruba Access Point returns data."""
