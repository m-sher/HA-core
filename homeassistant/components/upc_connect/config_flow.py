"""Config flow for the UPC Connect Box integration."""
...
class UpcConnectConfigFlow(ConfigFlow, domain=DOMAIN):
    """Handle a config flow for UPC Connect Box."""

    VERSION = 1

    async def _async_can_connect(self, user_input: dict[str, Any]) -> bool:
        """Return True if the UPC Connect Box at host authenticates successfully."""
